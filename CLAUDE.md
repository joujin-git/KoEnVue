...
├── UI/          Overlay (GDI rendering + floating positioning), Animation (WM_TIMER state machine), Tray (system tray + schtasks + cleanup dialog + scale input dialog), TrayIcon (GDI icon), SettingsDialog (scrollable 61-field config editor)
