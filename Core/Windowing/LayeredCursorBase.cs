...
/// <see cref="LayeredOverlayBase"/> 와 형제 — 한/영 배지는 GDI 텍스트/RoundRect/폰트/드래그/스냅
...
/// 한/영 배지 알파 race 미해결 영역에 변경면을 추가하지 않기 위한 의도적 분리. 공유 가능한
...
/// </para>
/// <para>
/// 콜백 시그니처 — 한/영 배지의 콜백 (hdc 받음) 과 다르게 ppvBits 를 직접 받는다. 커서 헤일로는
