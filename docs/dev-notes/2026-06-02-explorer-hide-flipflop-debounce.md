...
- "잠정 구간 상태 미갱신" 비대칭의 동형 설계 (cross-monitor anchor 동결):
  [2026-06-05-cross-monitor-shell-hide.md](2026-06-05-cross-monitor-shell-hide.md) — `TryHandleFilter`
  제3 케이스 "무시" 가 `LastNonFilteredForeground` anchor 를 같은 비대칭으로 동결한다.
