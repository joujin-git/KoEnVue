...
| [App/Config/DefaultConfig.cs](../App/Config/DefaultConfig.cs) | Magic-number constants: animation timings, pixel offsets, `DetectionBackoff{Step,Max}Ms`, `AppVersion = "0.9.2.4"`, `UpdateRepoOwner/Name`, system-input process list |
