...
| `Core/Windowing/Win32DialogHelper` | DPI 대응 다이얼로그 non-client 메트릭 + 9pt 시스템 폰트 헬퍼 (`ApplyFont`) |
...
리오르그 스펙은 `docs/reorg/`에 있으며 Stage 4의 세부 계약은 `docs/reorg/05-stage4-core-extraction.md`, 스타일 입력 감사는 `docs/reorg/stage4-style-audit.md` 참고.
