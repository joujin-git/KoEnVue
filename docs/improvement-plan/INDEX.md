...
**Current branch**: main (PR-10 머지 완료)
**Next PR**: PR-11/12 자유 선택
...
| 10 | CI + first tests                        | ✅     | (merged → main, de98e7b)        | Low     | M    | G1+G5. Tier-1+2 통과. xUnit 40/40 386 ms + AOT 4.81 MB. AppDomain unhandled + Task unobserved 핸들러 + CONTRIBUTING.md 신규 |
