...
**Current branch**: feat/pr-07-dialog-shell (Tier-1+2 통과, Tier-3 대기)
**Next PR**: PR-07 머지 후 PR-08/10/11 자유 선택
...
| 07 | DialogShell + a11y baseline             | 🚧     | feat/pr-07-dialog-shell         | Medium  | L    | C3+H4-b. Tier-1+2 통과. 라인 카운트 슬립 명시 (-13~-21%). 수동 smoke 대기 |
