...
| **잔여 Low** ◐ **부분 (2026-06-02)** | DUP-10·12, HC-18·19, IMP-5·6·7 | 기회 될 때 | S | 낮음 — **DUP-10·HC-18·HC-19·IMP-5·IMP-7 ✅ 완료** / **DUP-12·IMP-6 🔒 보류**(트레이 GDI 자동검증 불가·미래 DPI hook — 각 셀 근거). **HC-18 은 2026-06-02 후속 재평가로 진행**(Commit 단일 클램프 통일) |
