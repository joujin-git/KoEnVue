...
3. **GitHub 릴리스 작성** — 웹 UI `Releases → Draft a new release`
   - Tag: `vX.Y.Z.W` — 4-part 필수(숫자 4개, 점 3개, 1번 항목과 동일 컨벤션) + `v` 접두어 필수 (`UpdateChecker.NormalizeVersion` 이 벗겨냄)
   - Title: 자유 (예: `KoEnVue vX.Y.Z.W`)
...
- **P/Invoke**: User32, Imm32, Shell32, Gdi32, Kernel32, Shcore, Ole32, Dwmapi, WinHttp
