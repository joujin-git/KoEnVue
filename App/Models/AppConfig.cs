...
internal sealed record AppConfig
{
    ...
    // 한/영 배지를 숨긴 상태. 재기동·포그라운드 전환 시에도 유지.
    ...
    // [한/영 배지 위치 -- 저장 안 된 앱의 기본 표시 위치 (고정)]
    ...
    // [한/영 배지 위치 -- 저장 안 된 앱의 기본 표시 위치 (창 기준)]
...
/// <summary>
/// 저장 위치가 없는 앱에 한/영 배지를 표시할 기본 위치 (고정 모드).
...
/// <summary>
/// 저장 위치가 없는 앱에 한/영 배지를 표시할 기본 위치 (창 기준 모드).
