...
/// <summary>
/// 한/영 배지 배율 직접 입력용 Win32 모달 다이얼로그.
...
internal static class ScaleInputDialog
{
    ...
    // 범위/허용오차 상수
    // ================================================================
    /// <summary>한/영 배지 배율 최솟값 — <see cref="DefaultConfig.MinIndicatorScale"/> 와 동기.</summary>
    public const double ScaleMinValue = DefaultConfig.MinIndicatorScale;
    /// <summary>한/영 배지 배율 최댓값 — <see cref="DefaultConfig.MaxIndicatorScale"/> 와 동기.</summary>
